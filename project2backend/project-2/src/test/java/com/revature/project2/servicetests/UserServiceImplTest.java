...
public class UserServiceImplTest {
	...
	public void findByEmailTest() {
		User temp = new User(2,"susan@gmail.com","test");
		...
		Assertions.assertEquals(2, test.getUserId());
...
//		Assertions.assertEquals("susan@gmail.com", result.getEmail());
	...
	public void saveTest() {
		User test = new User(0,"test@gmail.com","password");
		service.save(test);
	...
	public void findByIdTest() {
		Optional<User> temp = Optional.ofNullable(new User(3,"don@gmail.com", "num123"));
